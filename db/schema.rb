...
ActiveRecord::Schema.define(version: 20160130062919) do
  ...
  add_index "speeches", ["debate_id"], name: "index_speeches_on_debate_id", using: :btree
  ...
  add_foreign_key "speeches", "debates"
